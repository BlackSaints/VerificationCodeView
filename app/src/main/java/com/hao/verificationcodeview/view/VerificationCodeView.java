package com.hao.verificationcodeview.view;
...
import com.hao.verificationcodeview.R;
...
public class VerificationCodeView extends RelativeLayout {
    ...
    private void setText(String content) {
        ...
        textViews[currentFocusPosition].setText(content);
    ...
    private void setCursorRes(int drawableRes) {
        try {
    ...
    private void layoutTextView() {
        ...
        if(codeNum > 1){
            ...
            for (int i = 0; i < codeNum; i++) {
                ...
                RelativeLayout.LayoutParams params1 = (LayoutParams) textViews[i].getLayoutParams();
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int mWidth = (int) (codeNum*codeWidth+dividerWidth*(codeNum-1));
        int mHeight = (int) codeWidth;
